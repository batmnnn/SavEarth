        ...
        <div className='text-4xl md:text-6xl font-extrabold text-green-500 pb-10 text-center '>About Us</div>
            ...
            <section className="mb-12">
                ...
                <div className="flex items-center mb-6">
                    <img src={shubham} className="w-24 h-22 rounded-full" alt="Adarsh Singh" />
                    <div className="ml-4">
                        <h3 className="text-xl font-semibold">Shubham Yadav</h3>
                ...
                <div className="flex items-center">
                    ...
                    <div className="ml-4">
                        <h3 className="text-xl font-semibold">Swastik Tiwari</h3>
